#include "aradani.h"
Sar(ddddd0, DDDDD A(n_t, O(0))) Sar(ddddd1, DDDDD A(n_t, O(1))) Sar(ddduu, DDD UU)
Nar(ara, P A4(n_t, ddddd0, ddddd1, ddduu, O(3)) PPPP)
Sar(dddd0, DDDD A(n_t, O(0))) Sar(dddu, DDD U)
Nar(da, P A3(n_t, dddd0, dddu, O(3)) PPP)
Sar(dddd1, DDDD A(n_t, O(1)))
Nar(an, P A3(n_t, dddu, dddd1, O(3)) PPP)
Sar(dddud, DDD U D) Sar(ddddu, DDD D U)
Nar(anda, PP A3(n_t, dddud, ddddu, O(4)) PPP)
Sar(ddddddu, DDDDD D U) Sar(dddddud, DDDDD U D) Sar(ddduudd, DDD UU DD)
